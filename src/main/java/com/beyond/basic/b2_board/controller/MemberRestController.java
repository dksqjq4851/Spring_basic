...
//    axios.patch
    ...
    public ResponseEntity<?> memberUpdatePw(@RequestBody MemberUpdateDto memberUpdateDto) {
        ...
        return new ResponseEntity<>(new CommonDto(HttpStatus.OK.value(), "member's pw is update", memberUpdateDto), HttpStatus.OK);
    ...
    public ResponseEntity<?> deleteMember(@PathVariable Long id){
        ...
        return new ResponseEntity<>(new CommonDto(HttpStatus.OK.value(),"member is delete", "ok"), HttpStatus.OK);
    }
